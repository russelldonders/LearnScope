...
// {url, about, publicProfileEnabled, brandPrimaryColor, ...} without `name`
// -- 0081's identity-change trigger only fires on an actual value change, so
// omitting `name` entirely here is what lets an org admin's update through
