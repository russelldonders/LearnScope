...
export default function SkillKnowledgeStatsModal({ librarySkillId, skillName, onClose }) {
  ...
  return (
    <AccessibleDialog
      labelledBy="skill-knowledge-stats-dialog-title"
      onClose={onClose}
    ...
    >
      <div className="flex items-center justify-between mb-1">
        <h2 id="skill-knowledge-stats-dialog-title" className="font-display text-2xl text-ink">
          Assessment stats — {skillName}
        </h2>
