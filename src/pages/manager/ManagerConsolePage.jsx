...
export default function ManagerConsolePage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setLedTeams(teams)
      if (requestedTeamId && !teams.some((item) => item.id === requestedTeamId)) {
        throw new Error('This team is not available. Open one of your teams from Connections.')
      }
  ...
  return <ManagerConsole team={team} learningRecords={learningRecords}
    teamOptions={ledTeams} selectedTeamId={teamId} onSelectTeam={(id) => {
